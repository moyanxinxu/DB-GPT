...
class BussinessPlanInput(BaseModel):
    """Plan input model."""
...
class BussinessPlanAction(Action[List[BussinessPlanInput]]):
    """Plan action class."""
    ...
    def out_model_type(self):
        """Output model type."""
        return List[BussinessPlanInput]
    ...
    async def run(
        ...
        **kwargs,
        ...
        try:
            param: List[BussinessPlanInput] = self._input_convert(
                ai_message, List[BussinessPlanInput]
            )
