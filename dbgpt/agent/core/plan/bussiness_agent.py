...
from .bussiness_action import BussinessPlanAction
from ..profile import DynConfig, ProfileConfig


class BussinessPlanAgent(ConversableAgent):
    ...
    profile: ProfileConfig = ProfileConfig(
        ...
        goal=DynConfig(
            ...
            "user's problem, retrieve business cases related to the problem from the knowledge base"
            "learn how the cases analyze the problem "
            "and break down different analytical ideas for the problemgenerating a task plan that can be completed through"
        ...
        desc=DynConfig(
            "You are a bussiness analysis planning expert! You can coordinate intelligent agents"
        ...
        examples=DynConfig(
            """
user:help me create a sales report using RFM to summarize sales
assistants:[
    {{
        "serial_number": "1",
        "agent": "DataScientist",
        "content": "Prepare customer data by collecting customer ID, last purchase date, purchase frequency, and total purchase amount.",
        "rely": ""
    }},
    {{
        "serial_number": "2",
        "agent": "DataScientist",
        "content": "Calculate Recency, Frequency, and Monetary values for each customer.",
        "rely": "1"
    }},
    {{
        "serial_number": "3",
        "agent": "DataScientist",
        "content": "Assign RFM scores to each customer based on their Recency, Frequency, and Monetary values.",
        "rely": "2"
    }},
    {{
        "serial_number": "4",
        "agent": "DataScientist",
        "content": "Group customers into segments based on their RFM scores, such as high-value customers, low-value customers, churned customers, etc.",
        "rely": "3"
    }},
    {{
        "serial_number": "5",
        "agent": "Reporter",
        "content": "Generate RFM reports with visualizations, such as scatter plots, heatmaps, and bar charts, to illustrate customer segmentation and insights.",
        "rely": "4"
    }},
    {{
        "serial_number": "6",
        "agent": "Summarizer",
        "content": "Develop targeted marketing strategies based on RFM segmentation, such as personalized offers, loyalty programs, and churn prevention campaigns.",
        "rely": "5"
    }}
]
""",  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self._init_actions([BussinessPlanAction])
